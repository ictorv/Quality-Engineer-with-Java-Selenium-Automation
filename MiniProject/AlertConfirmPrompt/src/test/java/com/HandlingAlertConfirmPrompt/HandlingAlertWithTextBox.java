...
public class HandlingAlertWithTextBox {
    ...
    public HandlingAlertWithTextBox(WebDriver driver, String name) {
        this.driver = driver;
        sendPrompt = name;
...
//    change for failing the test
    @FindBy(xpath = "//di[contains(@class,'col-md-12')]/div/div[2]/div[3]/button[contains(@class,'btn btn')]")
