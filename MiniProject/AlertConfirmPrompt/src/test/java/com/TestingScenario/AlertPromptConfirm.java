...
import com.BrowserConfiguration.DriverConfig;
import com.BrowserConfiguration.ExtentReportManager;
import com.HandlingAlertConfirmPrompt.HandlingAlertWithOKCancel;
import com.HandlingAlertConfirmPrompt.HandlingAlertWithOk;
import com.HandlingAlertConfirmPrompt.HandlingAlertWithTextBox;
...
public class AlertPromptConfirm {
    ...
    public void testAlertWithOk() {
        HandlingAlertWithOk hawk = new HandlingAlertWithOk(driver);
    ...
    public void testAlertWithOkCancel() {
        HandlingAlertWithOKCancel hawkc = new HandlingAlertWithOKCancel(driver);
    ...
    public void testAlertWithTextBox() {
        ...
        HandlingAlertWithTextBox hawtb = new HandlingAlertWithTextBox(driver, name);
