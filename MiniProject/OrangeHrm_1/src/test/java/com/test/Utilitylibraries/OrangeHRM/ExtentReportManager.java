...
public class ExtentReportManager {
	...
	public ExtentReportManager() {
		...
		ExtentSparkReporter sparkReporter = new ExtentSparkReporter(reportFolderPath + "\\OrangeHrm"+  folderName+".html");
		...
		// testLogger = extentreporkt.createTest("Zigly search products");
	}
