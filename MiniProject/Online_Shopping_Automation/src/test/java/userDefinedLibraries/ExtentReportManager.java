...
public class ExtentReportManager {
	...
	public ExtentReportManager() {
		...
		ExtentSparkReporter sparkReporter = new ExtentSparkReporter(reportFolderPath + "\\FlipKart_Report_" + folderName + ".html");

		sparkReporter.config().setDocumentTitle("Automation Extent Report");
		sparkReporter.config().setReportName("FlipKart Test Report");
