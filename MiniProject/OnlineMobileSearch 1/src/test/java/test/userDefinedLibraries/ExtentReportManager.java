...
public class ExtentReportManager {
	...
	public ExtentReportManager() {
		...
		ExtentSparkReporter sparkReporter = new ExtentSparkReporter(reportFolderPath + "\\SearchCoginzat"+  folderName+".html");
 
		sparkReporter.config().setDocumentTitle(" Amazon Mobile Filter Report");
 
		sparkReporter.config().setReportName("Amazon Mobile Filter Results");
