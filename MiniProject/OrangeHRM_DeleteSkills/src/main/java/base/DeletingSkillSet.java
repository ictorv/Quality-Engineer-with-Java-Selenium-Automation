...
public class DeletingSkillSet {
    ...
    public void loginToWebsite() throws IOException {
    		...
    		boolean a =loginObj.loginToWebsite();
    ...
    @Test(priority = 1,dependsOnMethods = {"loginToWebsite"}, dataProvider = "dp")
    ...
    @Test(priority = 2,dependsOnMethods = {"loginToWebsite"}, dataProvider = "dp")
    ...
    @Test(priority = 3,dependsOnMethods = {"loginToWebsite"}, dataProvider = "dp")
