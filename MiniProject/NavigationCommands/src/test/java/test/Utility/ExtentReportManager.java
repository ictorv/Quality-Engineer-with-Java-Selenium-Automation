...
public class ExtentReportManager {
	...
	public ExtentReportManager() {
		...
		ExtentSparkReporter sparkReporter = new ExtentSparkReporter(reportFolderPath + "\\NavigationCommands"+  folderName+".html");
 
		sparkReporter.config().setDocumentTitle("NavigationCommands_report");
 
		sparkReporter.config().setReportName("Navigation Commands Result");
